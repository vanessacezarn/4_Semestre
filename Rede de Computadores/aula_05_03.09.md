...
|  | |  |  |
| :-------: |  :-----:  | :-----------:  |  :----------: |
|  G ➔ J      |  10.0.0.32 |255.255.255.128| 200.25.0.38| 
|  G ➔ E      |   0.0.0.0  |    0.0.0.0    | 200.25.0.25| 
|G ➔ H (via E)|  10.0.2.0  | 255.255.255.240| 200.25.0.30| 
|entrada via E | 200.25.0.28| 255.255.255.252| 200.25.0.25|
|G ➔ F (via E)|  10.0.0.128|255.255.255.128| 200.25.0.22| 
|entrada via E | 200.25.0.20| 255.255.255.252| 200.25.0.25|
|G ➔ I (via E)|  10.0.2.16  |255.255.255.248 | 200.25.0.34| 
|entrada via E | 200.25.0.30| 255.255.255.252| 200.25.0.22|

### roteador H
|  | |  |  |
| :-------: |  :-----:  | :-----------:  |  :----------: |
|  H ➔ E      |   0.0.0.0  |    0.0.0.0    | 200.25.0.29| 

### roteador I
|  | |  |  |
| :-------: |  :-----:  | :-----------:  |  :----------: |
|  I ➔ F     |   0.0.0.0  |    0.0.0.0    | 200.25.0.33| 

### roteador J
|  | |  |  |
| :-------: |  :-----:  | :-----------:  |  :----------: |
|  J ➔ G   |   0.0.0.0  |    0.0.0.0    | 200.25.0.37| 
...
Router>en
  ...
  Router(config-if)# clock rate 250000 // somente do lado que tiver o relogio
  Router(config-if)#ip address 200.25.0.1 255.255.255.252
  ...
  Router(config-if)#no shut
  Router(config-if)#exit
  Router(config)#ip route 10.0.0.32 255.255.255.224 200.25.0.2
  Router(config)#exit
  Router#
  Router#wr
...
## TRABALHO FINALIZADO
<div align="center">
  <img width="1308" height="596" alt="image" src="https://github.com/user-attachments/assets/ab275bd8-6b33-4e2d-9adf-aa6fdbfd2968" />
